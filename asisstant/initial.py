...
STRINGS = {
    1: """ **Terima Kasih Telah Deploy Lucifer-UserBot!**

Beberapa Bantuan Untuk Kamu Pelajari.""",
    2: """🎉** Tentang Lucifer-UserBot**

 Lucifer-UserBot adalah repo userbot yanh dibuat untuk kekasih saya, userbot ini memiliki beberapa fitur kamu bisa melihat nya dihalaman 4.

❣ Dibuat oleh **@GokilSupport**""",
    3: """
...
-> Kamu bisa membalas seseorang dari Lucifer-UserBot Logs ketika kamu di tag oleh seseorang digrup lain.
